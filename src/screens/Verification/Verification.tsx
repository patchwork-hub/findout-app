...
const Verification: React.FC<SettingStackScreenProps<'Verification'>> = ({
  ...
  const { data: accountData, isLoading: isLoadingAccount, refetch } = useAccountInfo(
    accountQueryKey,
    { enabled: !!userInfo?.id }
  );
        ...
        <View className="flex-1 mx-4">
          <View className="mb-6">
            <ThemeText className="leading-6" size="sm_14">
              Verifying your identity on Mastodon is for everyone. Based on
              open web standards, now and forever free. All you need is a
              personal website that people recognize you by. When you link to
              this website from your profile, we will check that the website
              links back to your profile and show a visual indicator on it.
            </ThemeText>
          </View>
          ...
          <View className="mb-6">
            ...
            <ThemeText className="mb-4 leading-6" size="sm_14">
              Copy and paste the code below into the HTML of your website. Then
              add the address of your website into one of the extra fields on
              your profile from the "Edit profile" tab and save changes.
            </ThemeText>
            <View className="flex-row items-center bg-patchwork-grey-50 dark:bg-patchwork-grey-800 rounded-lg p-4">
              <View className="flex-1 mr-3">
                ...
                >
                  {verificationLink || t('verification.loading', 'Loading...')}
                </ThemeText>
              </View>
              <Button
                variant="default"
                ...
                className="px-6"
              >
                <ThemeText className="text-white font-medium">Copy</ThemeText>
              </Button>
            </View>
          </View>
          ...
          <View className="mb-6">
            <ThemeText className="leading-6" size="sm_14">
              ...
              which prevents impersonation on websites with user-generated
              content. You can even use a{' '}
              <ThemeText className="font-mono" size="sm_14">
                link
              </ThemeText>{' '}
              tag in the header of the page instead of a, but the HTML must be
